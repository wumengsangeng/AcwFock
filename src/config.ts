...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "22和33", // Credit text to be displayed
			url: "http://www.bilibili.com", // (Optional) URL link to the original artwork or artist's page
		},
	},
	toc: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// {
		// 	name: "GitHub",
		// 	url: "https://github.com/wumengsangeng/AcwFock", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/266717106",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/id/wumengsangeng/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/wumengsangeng",
		},
	],
};
